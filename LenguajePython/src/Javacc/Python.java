  ...
  final public void principal() throws ParseException {
    try {
      ...
      default:
        ...
        System.out.println("Programa principal no valido");
  ...
  final public void comentario() throws ParseException {
    try {
      ...
      default:
        ...
        System.out.println("Error en el comentario: " + e.getLocalizedMessage());
        ...
        } while((t.kind != COMENTARIO || nComillas != 3) && t.kind != EOF);
    }
  }
